...
2. Create a Convex project and run the dev server:
   ...
   npx convex dev
   ```
3. Set the Convex, OpenAI, and Clerk keys in your environment:
   ```bash
   ...
   # Add NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY, CLERK_SECRET_KEY, CLERK_ISSUER_URL, and CLERK_AUDIENCE from Clerk
   ```
4. Start Next.js:
   ```bash
   npm run dev
